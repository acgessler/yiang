...
namespace sf_yiang
{
	using namespace sf;
////////////////////////////////////////////////////////////
/// CustomString defines a graphical 2D text, that can be drawn on screen
////////////////////////////////////////////////////////////
class CustomString : public Drawable
{
public :
    ...
    ///
    ////////////////////////////////////////////////////////////
    explicit CustomString(const Unicode::Text& Text, const Font& CharFont = Font::GetDefaultFont(), float Size = 30.f);
